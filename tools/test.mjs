...
}
{
  ...
  const remind = await page.locator('[data-remind]').innerText();
  ok(remind.includes('Join our Remind with code dhscs27') && !remind.includes('81010'), 'Remind: join with code dhscs27');
