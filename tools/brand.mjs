...
const GRAD = `<linearGradient id="g" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#5b8cff"/><stop offset=".55" stop-color="#8b5cf6"/><stop offset="1" stop-color="#22d3ee"/></linearGradient>`;
...
const tile = (stroke = 2.6) =>
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40"><defs>${GRAD}</defs><rect x="1" y="1" width="38" height="38" rx="11" fill="#11131c" stroke="url(#g)" stroke-width="1.5"/>${GLYPH(stroke)}</svg>`;
/** Full-bleed version with safe-zone padding (maskable PWA icon). */
const maskable = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="-10 -10 60 60"><defs>${GRAD}</defs><rect x="-10" y="-10" width="60" height="60" fill="#0d0f17"/>${GLYPH(2.6)}</svg>`;
...
body{width:1200px;height:630px;overflow:hidden;background:#0a0b10;color:#eef0f7;font-family:IN;position:relative}
...
.o1{width:620px;height:620px;right:-120px;top:-260px;background:#4f6bff;opacity:.45}
.o2{width:560px;height:560px;left:-200px;bottom:-320px;background:#8b5cf6;opacity:.45}
.o3{width:360px;height:360px;left:520px;top:260px;background:#22d3ee;opacity:.18}
...
.muted{color:#8e97ab;font-weight:500}
h1{margin-top:auto;font-family:SG;font-weight:700;font-size:92px;line-height:.98;letter-spacing:-.045em}
.g{background:linear-gradient(110deg,#5b8cff,#8b5cf6 52%,#22d3ee);-webkit-background-clip:text;color:transparent}
...
.code{position:absolute;right:80px;top:150px;font-family:JB;font-size:22px;line-height:1.7;color:#6b7390;white-space:pre}
.code b{color:#c792ea;font-weight:400}.code i{color:#c3e88d;font-style:normal}
